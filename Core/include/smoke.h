...
#define SMOKE_GENTIME 211

#define SMOKE_NBPARTICLE 1000
#define SMOKE_LIFETIME_MIN 4600
#define SMOKE_LIFETIME_MAX 5000

#define SMOKE_SIZE_MIN 4
#define SMOKE_SIZE_MAX 5
#define SMOKE_VELOCITY_MIN 4
#define SMOKE_VELOCITY_MAX 6

#define SMOKE_RADIUS 4
#define SMOKE_CENTER Vec3(0,0,0)
#define SMOKE_SIZE_COEF 4
